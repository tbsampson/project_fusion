...
,AR.VJEDTN VNEDTN -- EDI - Transaction Number [Generic Edit] String (22)
...
,5000 VNEDBT -- EDI - Batch Number [Generic Edit] String (15)
...
,'          20' VNMCU -- Business Unit [Generic Edit] String (12)
,1225 VNOBJ -- Object Account [Generic Edit] String (6)
...
,'USD' VNCRCD -- Currency Code - From [Generic Edit] String (3)
...
,CAST(AR.VJAG * -1 AS INTEGER) VNAA -- Amount [Generic Edit] Numeric (15)
...
,'D' VNCRRM -- Currency Mode-Foreign or Domestic Entry [UDC (H00 CY)] Character (1)
...
,CAST(AR.VJAG * -1 AS INTEGER) VNAG -- Amount - Gross [Generic Edit] Numeric (15)
