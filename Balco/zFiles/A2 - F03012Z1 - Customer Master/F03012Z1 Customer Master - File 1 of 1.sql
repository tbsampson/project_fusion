-- CREATE VIEW _CUSTOMER_MASTER AS
/*
...
,ROW_NUMBER() OVER(ORDER BY	CUSTOMER.ID)  
            VOEDTN   -- EDI - Transaction Number String Generic Edit (22)
...
,CASE
    ...
    ELSE 0
 END        
            VOASTY   -- Amount - Invoiced This Year Numeric Generic Edit (15)
