...
LEFT JOIN _BT_ST BTST
	ON CUSTOMER_ORDER.CUSTOMER_ID = BTST.BILLTO_REF    

LEFT JOIN _BT_ST BTST2 
 ON 'BC_' + CUSTOMER_ORDER.CUSTOMER_ID + '_' 
    + Cast(CUSTOMER_ORDER.SHIP_TO_ADDR_NO AS NVARCHAR) = BTST2.SZALKY 	

WHERE  CUSTOMER_ORDER.ORDER_DATE >= '2017/10/1'
-- AND BTST.BILLTO_REF IS NULL
