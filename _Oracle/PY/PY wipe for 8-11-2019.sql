...
WHERE ALAN8 BETWEEN 72000 AND 98999 OR ABAN8 > 100000;
COMMIT;

DELETE FROM CRPDTA.F0115 -- phone number
WHERE WPAN8 BETWEEN 72000 AND 98999 OR ABAN8 > 100000;
COMMIT;

DELETE FROM CRPDTA.F01151 -- email addresses
WHERE EAAN8 BETWEEN 72000 AND 98999 OR ABAN8 > 100000;
COMMIT;

DELETE FROM CRPDTA.F0111 -- contacts
WHERE WWAN8 BETWEEN 72000 AND 98999 OR ABAN8 > 100000;
COMMIT;
...
DELETE FROM CRPDTA.F0911 WHERE RPDCT = 'XI' OR RPDCT = 'XM';
COMMIT;
