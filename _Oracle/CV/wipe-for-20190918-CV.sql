...
DELETE FROM CVDTA.F0401 -- vendor records
...
DELETE FROM CVDTA.F3003; -- Inventory OP Base aka Routing (Steve)
COMMIT;
...
DELETE FROM CVDTA.F49211; -- SO Tag (Ron) 
COMMIT;
...
DELETE FROM CVDTA.F00165; -- Media Object
COMMIT;
...
DELETE FROM CVDTA.F0911Z1; -- GL zFile
COMMIT;
