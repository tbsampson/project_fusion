...
,CASE
	...
	THEN 0
	WHEN ITEM_MASTER_1.SZSTKT = 'M' THEN CAST(((WORK_ORDER.ACT_MATERIAL_COST/WORK_ORDER.DESIRED_QTY) * 1.7) * 100 AS BIGINT)
	ELSE CAST((WORK_ORDER.ACT_MATERIAL_COST/WORK_ORDER.DESIRED_QTY) * 100 AS BIGINT)
