...
DELETE CVDTA.F4101 
WHERE IMITM >= 50000; -- Item Master

DELETE CVDTA.F4102
WHERE IBITM >= 50000; -- Item Branch Plant
 
DELETE CVDTA.F4105 
WHERE COITM >= 50000; -- Item Cost

DELETE CVDTA.F4141 
WHERE PJITM >= 50000; -- Cycle Counts

DELETE CVDTA.F41021
WHERE LIITM >= 50000; -- Item Location

DELETE CVDTA.F4111 
WHERE ILITM >= 50000; -- Item Ledger
COMMIT;
